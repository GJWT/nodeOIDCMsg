...
describe('When signing an x509 certificate', function () {
    ...
    var priv = fs.readFileSync("/Users/anjuthomas/Documents/rolandPriv.pem");
    var pub = fs.readFileSync("/Users/anjuthomas/Documents/rolandPub.pem");
    ...
    it('should work with the corresponding pub key 1', function () {
      var verified = jwtDecoder.verifyJwtSignatureUsingKeys(token, pub, basicIdToken,  {"clockTimestamp" : clockTimestamp, jwtid: 'jwtid', algorithm: 'HS256'}, "base64");
...
describe('When signing an x509 certificate', function () {
  ...
  var priv = fs.readFileSync("/Users/anjuthomas/Documents/example_key.pem");
  var pub = fs.readFileSync("/Users/anjuthomas/Documents/example_pub_key.pem");
...
describe('When signing an x509 certificate', function () {
    ...
    it('should work with a JWK input', function () {
      var verified = jwtDecoder.verifyJwtSignatureUsingJwk(token, pub, basicIdToken,  {"clockTimestamp" : clockTimestamp, jwtid: 'jwtid', algorithm: 'HS256'}, JSON.stringify(jwk), "base64");
      assert.equal(verified, true);
    });
  });
